...
//========================================================================================
  ...
  Mono<User> capitalizeOne(Mono<User> mono) {
    return mono.map(user -> createCapitalized(user));
  }

  private User createCapitalized(User user) {
...
//========================================================================================
  ...
  Flux<User> capitalizeMany(Flux<User> flux) {
    return flux.map(this::createCapitalized);
  }
...
//========================================================================================
  ...
  Mono<User> asyncCapitalizeUser(User u) {
    return Mono.just(createCapitalized(u));
  }
}
